...
layui.use(['layer', 'form', 'admin', 'laydate', 'ax'], function () {
    ...
    //获取菜单信息
    var ajax = new $ax(Feng.apiPath + "/menu/getMenuInfo?menuId=" + Feng.getUrlParam("menuId"));
    ...
    $('#pcodeName').click(function () {
        ...
        var treeUrl = encodeURIComponent(Feng.apiPath + "/menu/selectMenuTreeList");
    ...
    form.on('submit(btnSubmit)', function (data) {
        var ajax = new $ax(Feng.apiPath + "/menu/edit", function (data) {
            Feng.success("修改成功！");
