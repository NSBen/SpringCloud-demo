...
layui.use(['layer', 'form', 'admin', 'ax'], function () {
    ...
    //初始化角色的详情数据
    var ajax = new $ax(Feng.apiPath + "/role/view/" + Feng.getUrlParam("roleId"));
    ...
    $('#pName').click(function () {
        ...
        var treeUrl = encodeURIComponent(Feng.apiPath + "/role/roleTreeList");
    ...
    form.on('submit(btnSubmit)', function (data) {
        var ajax = new $ax(Feng.apiPath + "/role/edit", function (data) {
            Feng.success("修改成功!");
